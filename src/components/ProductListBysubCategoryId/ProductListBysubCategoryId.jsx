import '../../App.css';
import './productListBysubCategory.scss';
...
function ProductListBysubCategoryId({ appRefresher, setAppRefresher }) {
  ...
  useEffect(() => {
    if (IsCurrentUser != null) {
      const getProductsbyKey = async () => {
        try {
          const res = await publicRequest.get(`Home/get-products/${subCategoryId}`, {
            headers: {
            ...
            <div className="col-lg-6 col-md-6 col-sm-12">
              ...
              <div>
                ...
                {productDetails.discountPrice === 0 ? (
                  ...
                  <>
                    <span className="p-price">RS: {productDetails.discountPrice}</span>
                    <br></br>
                    <span>RS: {productDetails.price}</span>
                  </>
                )}
...
export default ProductListBysubCategoryId;
