...
function ProductByMainCategoryId({ appRefresher, setAppRefresher }) {
  ...
  useEffect(() => {
    if (IsCurrentUser != null) {
      const getProductsbyKey = async () => {
        try {
          const res = await publicRequest.get(`Home/get-mainCategory-products/${mainCategoryId}`, {
            headers: {
...
export default ProductByMainCategoryId;
