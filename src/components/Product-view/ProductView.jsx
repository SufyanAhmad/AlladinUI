              ...
              <div className="product-card">
                <div className="row">
                  <div className="col-lg-6 col-md-12 col-sm-12" style={{ textAlign: 'center' }}>
                    <Carousel showThumbs={media.length === 0 ? false : true} style={{ overflow: 'scroll' }} infiniteLoop>
                      {media.map((d, index) => (
                        <div key={index} className="image d-flex justify-content-center">
                          <img src={d.imgUrl} alt="product" className='hover-zoom' />
                        </div>
                      ))}
